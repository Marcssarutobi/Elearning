    ...
    <div>
        ...
        <section class="top-position1 p-0">
            <div class="container-fluid px-0">
                <Swiper :navigation="true" :modules="modules" :loop="true" :autoplay="{ delay: 2500, disableOnInteraction: false }" class="mySwiper slider-fade1 owl-carousel owl-theme w-100">
                    <SwiperSlide class="item bg-img bg-img1 cover-background pt-6 pb-10 pt-sm-6 pb-sm-14 py-md-16 py-lg-20 py-xxl-24 left-overlay-dark" data-overlay-dark="8" data-background="img/banner/slide1.jpg" >
                    ...
                    <SwiperSlide class="item bg-img bg-img2 cover-background pt-6 pb-10 pt-sm-6 pb-sm-14 py-md-16 py-lg-20 py-xxl-24 left-overlay-dark" data-overlay-dark="8" data-background="img/banner/slide2.jpg">
                        <div class="container pt-6 pt-md-0">
                            <div class="row align-items-center">
                                <div class="col-md-10 col-lg-8 col-xl-7 mb-1-9 mb-lg-0 py-6 position-relative">
                                    <span class="h5 text-secondary">Enjoy smooth learning</span>
                    ...
                    <SwiperSlide class="item bg-img bg-img3 cover-background pt-6 pb-10 pt-sm-6 pb-sm-14 py-md-16 py-lg-20 py-xxl-24 left-overlay-dark" data-overlay-dark="8" data-background="img/banner/slide3.jpg">
                        <div class="container pt-6 pt-md-0">
                            <div class="row align-items-center">
                                <div class="col-md-10 col-lg-8 col-xl-7 mb-1-9 mb-lg-0 py-6 position-relative">
                                    <span class="h5 text-secondary">Enjoy smooth learning</span>
                ...
                <div class="row g-xxl-5 mt-n2-6">
                    ...
                    <div class="col-md-6 col-xl-4 mt-2-6">
                        <div class="card card-style1 p-0 h-100">
                            <div class="card-img rounded-0">
                                <div class="image-hover">
                                    <img class="rounded-top" src="../../assets/img/content/courses-05.jpg" alt="...">
                                </div>    
                    ...
                    <div class="col-md-6 col-xl-4 mt-2-6">
                        <div class="card card-style1 p-0 h-100">
                            <div class="card-img rounded-0 border-color-secondary">
                                <div class="image-hover">
                                    <img class="rounded-top" src="../../assets/img/content/courses-06.jpg" alt="...">
                                </div>    
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 position-relative">
                        <Swiper :modules="modules" :loop="true" :autoplay="{ delay: 2500, disableOnInteraction: false }" class="testimonial-carousel text-center owl-carousel owl-theme">
                            <SwiperSlide>
            ...
            <div class="container">
                ...
                <div class="row g-xxl-5 mt-n2-9">
                    <div class="col-xl-6 mt-2-9">
                        <div class="row g-0 event-wrapper">
                            <div class="col-md-5 event-img bg-img cover-background">
                                <img src="../../assets/img/content/event-01.jpg" />
                            </div>
                            <div class="col-md-7">
                    ...
                    <div class="col-xl-6 mt-2-9">
                        <div class="row g-0 event-wrapper">
                            <div class="col-md-5 event-img bg-img cover-background">
                                <img src="../../assets/img/content/event-02.jpg" />
                            </div>
                            <div class="col-md-7">
                                <div class="p-1-6 p-sm-1-9">
                    ...
                    <div class="col-xl-6 mt-2-9">
                        <div class="row g-0 event-wrapper">
                            <div class="col-md-5 event-img bg-img cover-background" >
                                <img src="../../assets/img/content/event-03.jpg" />
                            </div>
                            <div class="col-md-7">
                                <div class="p-1-6 p-sm-1-9">
                    ...
                    <div class="col-xl-6 mt-2-9">
                        <div class="row g-0 event-wrapper">
                            <div class="col-md-5 event-img bg-img cover-background" >
                                <img src="../../assets/img/content/event-04.jpg" />
                            </div>
                            <div class="col-md-7">
                                <div class="p-1-6 p-sm-1-9">
...
<style>
    ...
    .bg-img1{
        background: url(../../assets/img/banner/slide1.jpg);
    }
    .bg-img2{
        background: url(../../assets/img/banner/slide2.jpg);
    }
    .bg-img3{
        background: url(../../assets/img/banner/slide3.jpg);
    }
    .bg-very-light-gray{
        padding: 30px 0;
    }
