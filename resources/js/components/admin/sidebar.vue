          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      <li class="active">
                          <router-link to="/home" class="svg-icon">                        
                      ...
                      <li class="">
                        <a href="#otherpage" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">
                            ...
                            <i class="fa-regular fa-caret-right iq-arrow-right arrow-hover"></i>
                            <i class="fa-regular fa-caret-down iq-arrow-right arrow-active"></i>
                        </a>
                        <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="">
                                <router-link to="/courseadmin" class="svg-icon sub">
                                   <i class="fa-regular fa-book"></i>
                                    <span class="ml-4">Course</span>
                                </router-link>
                            </li>
                            <li class="">
                                <router-link to="/sessionsadmin" class="svg-icon sub">
                                    <i class="fa-regular fa-list-radio"></i>
                                    <span class="ml-4">Session</span>
                                </router-link>
                            </li>
                            <li class="">
                                <a href="../backend/timeline.html" class="svg-icon sub">
                                    <i class="fa-regular fa-list-tree"></i>
                                    <span class="ml-4">Lesson</span>
                                </a>
                            </li>
                        </ul>
                      </li>
                          ...
                          <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                  ...
                                  <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-0 ">
                                              ...
                                              <div class="px-2 pt-0 pb-0 sub-card" >
                                                  <a href="#" class="iq-sub-card" style="padding: 0px;">
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="../../../assets/user/01.jpg" alt="01">
                                                          </div>
                                                  ...
                                                  <a href="#" class="iq-sub-card" style="padding: 0px;">
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small" src="../../../assets/user/02.jpg" alt="02">
                                                          </div>
                                                          <div class="media-body ml-3">
                                                              <div class="d-flex align-items-center justify-content-between">
                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4"
                                      data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <img src="../../../assets/user/1.jpg" class="img-fluid rounded-circle" alt="user">
...
<style scoped>
    @import url("../../../../public/admin/css/backend-plugin.min.css");
    @import url("../../../../public/admin/css/backend.css");
