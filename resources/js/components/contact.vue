<template>
    <div>
        ...
        <!-- PAGE TITLE
        ================================================== -->
        <section class="page-title-section bg-img bg-cts cover-background top-position1 left-overlay-dark" data-overlay-dark="9" data-background="img/bg/bg-04.jpg">
            <div class="container">
            ...
            <div class="container">
                <div class="row align-items-end">
                    <div class="col-lg-6 d-none d-lg-block">
                        <img src="../../assets/img/content/contact-img-01.jpg" alt="...">
                    </div>
                    <div class="col-lg-6">
                        <div class="faq-form">
