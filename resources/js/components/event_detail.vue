<template>
    <div>
        ...
        <!-- PAGE TITLE
        ================================================== -->
        <section class="page-title-section bg-img bg-end cover-background top-position1 left-overlay-dark" data-overlay-dark="9" data-background="img/bg/bg-04.jpg">
            <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-1-6 mb-md-1-9">
                                <div class="event-details-img position-relative">
                                    <img class="border-radius-5" src="../../assets/img/content/event-details-01.jpg" alt="...">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
