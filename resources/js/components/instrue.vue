<template>
    <div>
        ...
        <!-- PAGE TITLE
        ================================================== -->
        <section class="page-title-section bg-img bg-int cover-background top-position1 left-overlay-dark" data-overlay-dark="9" data-background="img/bg/bg-04.jpg">
            <div class="container">
                ...
                <div class="container">
                    ...
                    <div class="row">
                                ...
                                <div class="team-overlay">
                                    <div class="d-table h-100 w-100">
                                        <div class="d-table-cell align-middle">
                                            <h3><router-link to="/instructors_details" class="text-white">About Murilo Souza</router-link></h3>
                        ...
                        <div class="col-lg-4 col-md-6 mb-1-6 mb-md-1-9 mb-lg-0">
                            <div class="team-style1 text-center">
                                <img src="../../assets/img/team/team-04.jpg" class="border-radius-5" alt="...">
                                <div class="team-info">
                                ...
                                <div class="team-overlay">
                                    <div class="d-table h-100 w-100">
                                        <div class="d-table-cell align-middle">
                                            <h3><a href="instructors-details.html" class="text-white">About Melissa Padgett</a></h3>
                                            <p class="text-white mb-0">I preserve each companion certification and I'm an authorized AWS solutions architect professional.</p>
                                            <ul class="social-icon-style1">
                                                <li><a href="#!"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#!"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 mb-1-6 mb-md-0">
                            <div class="team-style1 text-center">
                                <img src="../../assets/img/team/team-05.jpg" class="border-radius-5" alt="...">
                                <div class="team-info">
                                ...
                                <div class="team-overlay">
                                    <div class="d-table h-100 w-100">
                                        <div class="d-table-cell align-middle">
                                            <h3><a href="instructors-details.html" class="text-white">About Austin Smith</a></h3>
                                            <p class="text-white mb-0">I preserve each companion certification and I'm an authorized AWS solutions architect professional.</p>
                                            <ul class="social-icon-style1">
                                                <li><a href="#!"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#!"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="team-style1 text-center">
                                <img src="../../assets/img/team/team-06.jpg" class="border-radius-5" alt="...">
                                <div class="team-info">
                                ...
                                <div class="team-overlay">
                                    <div class="d-table h-100 w-100">
                                        <div class="d-table-cell align-middle">
                                            <h3><a href="instructors-details.html" class="text-white">About Leigh Minarik</a></h3>
                                            <p class="text-white mb-0">I preserve each companion certification and I'm an authorized AWS solutions architect professional.</p>
                                            <ul class="social-icon-style1">
                                                <li><a href="#!"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#!"><i class="fab fa-twitter"></i></a></li>
